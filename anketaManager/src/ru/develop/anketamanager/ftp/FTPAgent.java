...
public final class FTPAgent {
	...
	static final String  tagLog = "FTPClient"; 
	public static Boolean Exec (String param,StringOutputStream sos,FtpSendTask ft) throws UnknownHostException
    {
        ...
        if (protocol == null ) {
            if(proxyHost !=null) {
            	...
            	Log.i(tagLog,"Using HTTP proxy server: " + proxyHost);
...
__main:
        try
        {
            ...
            Log.i(tagLog,"Remote system is " + ftp.getSystemType());
            ...
            else if (feat)
            {
                ...
                if (remote != null) { // See if the command is present
                   ...
                   //     System.out.println("Has feature: "+remote);
                        Log.i(tagLog,"Has feature: "+remote);                    	
                    } else {
                        if (FTPReply.isPositiveCompletion(ftp.getReplyCode())) {
                       //     System.out.println("FEAT "+remote+" was not detected");
                            Log.i(tagLog,"FEAT "+remote+" was not detected");
                        } else {
                    ...
                    if (features != null) {
                        for(String f : features) {
                         //   System.out.println("FEAT "+remote+"="+f+".");
                            Log.i(tagLog,"FEAT "+remote+"="+f+".");
                        }
                    } else {
                        if (FTPReply.isPositiveCompletion(ftp.getReplyCode())) {
                         //   System.out.println("FEAT "+remote+" is not present");
                            Log.i(tagLog,"FEAT "+remote+" is not present");
                        } else {
                          //  System.out.println("Command failed: "+ftp.getReplyString());
                            Log.i(tagLog,"Command failed: "+ftp.getReplyString());
                        }
