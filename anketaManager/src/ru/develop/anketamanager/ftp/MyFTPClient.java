...
public class MyFTPClient {
	...
	TextView _errorLog;
	public MyFTPClient(TextView _visualElement)
	{
	_errorLog = _visualElement;
	}
	                          ...
	                          String password, int port)
	{
	    try {
	        ...
	        mFTPClient.addProtocolCommandListener(new ProtocolCommandListener() {
				
				@Override
				public void protocolReplyReceived(ProtocolCommandEvent arg0) {
					// TODO Auto-generated method stub
					if(_errorLog!=null)
					 _errorLog.setText(arg0.getCommand());
				}
